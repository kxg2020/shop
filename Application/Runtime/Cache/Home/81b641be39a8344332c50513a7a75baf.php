...
<head>
	...
	<link rel="stylesheet" href="/Public/style/goods.css" type="text/css">
	<link rel="stylesheet" href="/Public/style/common.css" type="text/css">
	
	<!--引入jqzoom css -->
	<link rel="stylesheet" href="/Public/style/jqzoom.css" type="text/css">

	<script type="text/javascript" src="/Public/js/jquery-1.8.3.min.js"></script>
	<script type="text/javascript" src="/Public/js/header.js"></script>
	<script type="text/javascript" src="/Public/js/goods.js"></script>
	<script type="text/javascript" src="/Public/js/jqzoom-core.js"></script>
...
<div style="clear:both;"></div>
	...
	<div class="main w1210 mt10 bc">
		...
		<div class="goods_content fl mt10 ml10">
			<!-- 商品概要信息 start -->
			<div class="summary">
				<h3><strong><?php echo ($goods["name"]); ?></strong></h3>
				
				<!-- 图片预览区域 start -->
				<div class="preview fl">
					<div class="midpic" style="width: 350px; height: 350px;display:table-cell;text-align:center;vertical-align:middle;">
						<a href="<?php echo ($goods["image"]); ?>" style="vertical-align: middle; display: block;"  class="jqzoom" rel="gal1">   <!-- 第一幅图片的大图 class 和 rel属性不能更改 -->
							<img src="<?php echo ($goods["image"]); echo ($mExt); ?>" alt=""/>               <!-- 第一幅图片的中图 -->
						</a>
					</div>
					...
					<div class="smallpic">
						...
						<div class="smallpic_wrap">
							<ul>
								<li class="cur">
									<a class="zoomThumbActive" href="javascript:void(0);" rel="{gallery: 'gal1', smallimage: '<?php echo ($goods["image"]); echo ($mExt); ?>',largeimage: '<?php echo ($goods["image"]); ?>'}"><img src="<?php echo ($goods["image"]); echo ($smallExt); ?>"></a>
								</li>
								<?php if(is_array($goodsImages)): $i = 0; $__LIST__ = $goodsImages;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$gi): $mod = ($i % 2 );++$i;?><li>
										<a href="javascript:void(0);" rel="{gallery: 'gal1', smallimage: '<?php echo ($gi["path"]); echo ($mExt); ?>',largeimage: '<?php echo ($gi["path"]); ?>'}"><img src="<?php echo ($gi["path"]); echo ($smallExt); ?>"></a>
				...
				<div class="goodsinfo fl ml10">
					<ul>
						...
						<li><span>上架时间：</span><?php echo date('Y-m-d', $goods['inputtime']);?></li>
						<li class="star"><span>商品评分：</span> <strong></strong><a href="">(已有21人评价)</a></li> <!-- 此处的星级切换css即可 默认为5星 star4 表示4星 star3 表示3星 star2表示2星 star1表示1星 -->
						<li><span>商品热度：</span><label id="clicks"></label></li>
					</ul>
					<form action="<?php echo U('Cart/add', ['goods_id' => $goods['id']]);?>" method="post" class="choose">
						<ul>
			...
			<div class="detail">
				...
				<div class="detail_bd">
					...
					<div class="introduce detail_div">
						...
						<div class="desc mt10" id="goodsContent">
...
<!-- 底部版权 end -->
	...
	<script type="text/javascript">
		...
		$(function(){
			// 页面加载完成之后再执行
			var _uri = '<?php echo U("Goods/getClicks", ["goods_id"=> $goods["id"]]);?>';
			$.getJSON(_uri, '', function (response) {
				$('#clicks').html(response.click)
			});
			var _contentUrl = '<?php echo U("Goods/getContent", ["goods_id"=> $goods["id"]]);?>'
			$.getJSON(_contentUrl, '', function(data){
//				console.log(data);
