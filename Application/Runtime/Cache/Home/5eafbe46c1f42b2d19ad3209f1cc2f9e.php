...
<body>
	...
	<!-- 登录主体部分start -->
	<div class="sendBox">
		<?php if($error == 1): ?><a href="#">重新发送激活邮件(<?php echo ($user["email"]); ?>)</a>
			<?php else: ?>
			<h3>恭喜您（<span style="color: red;"><?php echo ($user["phone"]); ?></span>）!已经激活成功</h3>
			<p style="text-align: center; line-height: 50px; font-size: 18px;">你现在可以尽情消费了！<a href="#">登录</a> </p><?php endif; ?>
	</div>
	<!-- 登录主体部分end -->
