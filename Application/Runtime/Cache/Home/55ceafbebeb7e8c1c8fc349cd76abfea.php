...
<body>
	...
	<!-- 登录主体部分start -->
	<div class="sendBox">
		<h3>恭喜您（<span style="color: red;"><?php echo ($user["phone"]); ?></span>）!注册成功</h3>
		<p style="text-align: center; line-height: 50px; font-size: 18px;">我们已经发送了一封激活邮件到：<a href="#"><?php echo ($user["email"]); ?></a>里！请在10分钟内登录邮箱点击链接激活</p>
		<?php if($error == 1): ?>您的邮件发送失败！请重新发送！<?php endif; ?>
	</div>
	<!-- 登录主体部分end -->
