...
<div class="sendBox">
	<h3>订单已经提交成功！</h3>
	<!--<?php echo ($error); ?>-->
	<p style="text-align: center">你这个订单总价：<strong><?php echo sprintf("%.2f",($order['price']*100+$order['delivery_price']*100)/100);?></strong></p>
	<p style="text-align: center; line-height: 50px;">
		你选择的是 《<?php echo ($order["pay_type_name"]); ?>》
		<a href="<?php echo U('Order/pay', ['orderid' => $order['id']]);?>">去支付</a>
	</p>
</div>
<!-- 登录主体部分end -->
