...
<div class="sendBox">
	<h3>商品加入购物车成功了！</h3>
	<!--<?php echo ($error); ?>-->
	<p style="text-align: center">商品：<?php echo ($goods["name"]); ?> 数量：<?php echo ($amount); ?></p>
	<p style="text-align: center; line-height: 50px;">
		<a href="<?php echo U('Goods/detail', ['id' => $goods['id']]);?>" style="padding: 5px 10px; background: green; color: #fff; border-radius: 5px;">返回</a>
		<a href="#" style="padding: 5px 10px; background: #ff6600; color: #fff; border-radius: 5px;">前往购物车结算</a></p>
</div>
<!-- 登录主体部分end -->
