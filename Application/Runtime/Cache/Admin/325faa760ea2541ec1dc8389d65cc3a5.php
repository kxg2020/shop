...
<head>
    ...
    <link href="http://admin.shop.com/Public/css/style.css" rel="stylesheet">
    <link href="http://admin.shop.com/Public/css/style-responsive.css" rel="stylesheet">
...
<div class="container">
    ...
    <form class="form-signin" action="<?php echo U();?>" method="post">
        <div class="form-signin-heading text-center">
            ...
            <img src="http://admin.shop.com/Public/images/login-logo.png" alt=""/>
        </div>
...
<!-- Placed js at the end of the document so the pages load faster -->
<script src="http://admin.shop.com/Public/js/modernizr.min.js"></script>
