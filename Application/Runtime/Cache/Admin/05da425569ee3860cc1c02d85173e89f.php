                    ...
                    <div class="panel-body">
                        ...
                        <div class="adv-table">
                            <table  class="display table table-bordered table-striped tree" id="dynamic-table">
                                ...
                                <tbody>
                                <?php if(is_array($lists)): $i = 0; $__LIST__ = $lists;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?><tr class="gradeX treegrid-<?php echo ($list["id"]); ?>  <?php if($list['parent_id']): ?>treegrid-parent-<?php echo ($list["parent_id"]); endif; ?>">
                                        <td><?php echo ($list["id"]); ?></td>
                                        <td>
                                            <?php $__FOR_START_7361__=1;$__FOR_END_7361__=$list['level'];for($i=$__FOR_START_7361__;$i < $__FOR_END_7361__;$i+=1){ ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php } ?>
                                            <?php echo ($list["name"]); ?></td>
