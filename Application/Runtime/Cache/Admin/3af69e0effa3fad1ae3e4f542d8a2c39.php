                ...
                <section class="panel">
                    ...
                    <div class="panel-body">
                        <form class="form-inline" action="<?php echo U();?>">
                            ...
                            <div class="form-group">
                                <label for="exampleInputEmail2">联系人电话</label>
                                <input type="text" class="form-control" id="exampleInputEmail2" name="phone" value="<?php echo I('get.phone');?>">
                            </div>
