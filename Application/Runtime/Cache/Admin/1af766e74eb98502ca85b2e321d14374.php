            ...
            <section class="panel">
                ...
                <div class="panel-body">
                    <form role="form" action="<?php echo U('edit', array('id' => $info['id']));?>" method="post">
                        ...
                        <div class="form-group">
                            <label>联系人</label>
                            <input type="text" class="form-control" name="connecter" placeholder="" value="<?php echo ($info["connecter"]); ?>">
                        </div>
                        <div class="form-group">
                            <label>联系电话</label>
                            <input type="text" class="form-control" name="phone" placeholder="" value="<?php echo ($info["phone"]); ?>">
                        </div>
                        <div class="checkbox">
                            <label>
